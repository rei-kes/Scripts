...
local HitscanSilentAimBox = AimbotTab:AddLeftTabbox() -- << placeholder
...
local MeleeSilentAimBox = AimbotTab:AddLeftTabbox() -- << even more of a placeholder
    local MeleeSilentAimTab = MeleeSilentAimBox:AddTab("Auto Melee")
    MeleeSilentAimTab:AddToggle("MeleeSilentAim", { Text = "Silent Aim" }):AddKeyPicker("MeleeSilentAimKey", { Text = "Silent Aim", Default = "ButtonStart", Mode = "Hold" })
    local MeleeSilentAimSettings = MeleeSilentAimBox:AddTab("Settings")
    MeleeSilentAimSettings:AddToggle("MeleeToggleThing", { Text = "some random toggle" })

local ProjectileSilentAimBox = AimbotTab:AddRightTabbox()
    ...
    ProjectileSilentAimTab:AddToggle("ProjectileWaitForCharge", { Text = "Wait For Charge" })
    ProjectileSilentAimTab:AddSlider("StrafeSamples", { Text = "Strafe Samples", Default = 5, Min = 0, Max = 25, Rounding = 0 })
